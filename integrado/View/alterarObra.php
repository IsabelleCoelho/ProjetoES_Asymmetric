      ...
      <body>
        <div class="conteinerFormulario">
          ...
          <form id="formulario" method="POST" action="../Controller/AtualizarObra.php" enctype="multipart/form-data">
            ...
            <div class="input">
              <label for="number">Altura</label><br>
              <input type="number" step="0.01" name="altura" value="<?php echo $obraAtual->getAltura(); ?>" required />
            </div>
            <div class="input">
              <label for="number">Largura</label><br>
              <input type="number" step="0.01" name="largura" value="<?php echo $obraAtual->getLargura(); ?>" required />
            </div>
            <div class="input">
              <label for="number">Valor</label><br>
              <input type="number" name="valorEstimado" value="<?php echo $obraAtual->getValorEstimado(); ?>" required />
            </div>
            <div class="input">
            ...
            <div id="botoes">
              <a href="admin-page.php">
                ...
                <button type="submit" name="enviarObra" style="padding: 8px 18px; margin-right: 20px;">Confirmar</button>
            </div>
          </form>
        </div>
      </body>
