            ...
            <body style="margin-top:0px;">
                <div style="padding-left:20%; padding-right:20%;">
                    <div style="width:100%; height:30px; background-color:grey; margin-bottom:10px;">
                        <a href="editar-dados.php" style="color:white; margin-left:33%;">Perfil</a>
<?php                   if (isset($_SESSION['carrinho'])) {
                            echo '<a href="carrinho.php" style="color:white; margin-right:33%; float:right;">Carrinho: '.count($_SESSION['carrinho']).' itens</a>';
                        } else {
                            echo '<a href="carrinho.php" style="color:white; margin-right:33%; float:right;">Carrinho vazio.</a>';
                        } ?>
                    </div>
